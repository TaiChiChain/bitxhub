...
func (_BindingContract *BindingContractCaller) TotalSupply(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _BindingContract.contract.Call(opts, &out, "totalSupply")
...
//
// Solidity: function totalSupply() view returns(uint256)
func (_BindingContract *BindingContractSession) TotalSupply() (*big.Int, error) {
	return _BindingContract.Contract.TotalSupply(&_BindingContract.CallOpts)
}

// TotalSupply is a free data retrieval call binding the contract method 0x18160ddd.
//
// Solidity: function totalSupply() view returns(uint256)
func (_BindingContract *BindingContractCallerSession) TotalSupply() (*big.Int, error) {
	return _BindingContract.Contract.TotalSupply(&_BindingContract.CallOpts)
}
