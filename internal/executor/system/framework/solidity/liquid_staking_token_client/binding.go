...
func (_BindingContract *BindingContractTransactor) Approve(opts *bind.TransactOpts, _approved common.Address, _tokenId *big.Int) (*types.Transaction, error) {
	return _BindingContract.contract.Transact(opts, "approve", _approved, _tokenId)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address _approved, uint256 _tokenId) payable returns()
func (_BindingContract *BindingContractSession) Approve(_approved common.Address, _tokenId *big.Int) (*types.Transaction, error) {
	return _BindingContract.Contract.Approve(&_BindingContract.TransactOpts, _approved, _tokenId)
}

// Approve is a paid mutator transaction binding the contract method 0x095ea7b3.
//
// Solidity: function approve(address _approved, uint256 _tokenId) payable returns()
func (_BindingContract *BindingContractTransactorSession) Approve(_approved common.Address, _tokenId *big.Int) (*types.Transaction, error) {
	return _BindingContract.Contract.Approve(&_BindingContract.TransactOpts, _approved, _tokenId)
}
...
//
// Solidity: event UpdateInfo(uint256 indexed _tokenId, uint256 newPrincipal, uint256 newUnlocked, uint64 newActiveEpoch)
