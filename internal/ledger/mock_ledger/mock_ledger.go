...
import (
	...
	utils "github.com/axiomesh/axiom-ledger/internal/ledger/utils"
...
// ApplyStateJournal mocks base method.
func (m *MockStateLedger) ApplyStateJournal(blockNumber uint64, stateJournal *types.StateJournal) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ApplyStateJournal", blockNumber, stateJournal)
	ret0, _ := ret[0].(error)
	return ret0
}

// ApplyStateJournal indicates an expected call of ApplyStateJournal.
func (mr *MockStateLedgerMockRecorder) ApplyStateJournal(blockNumber, stateJournal any) *MockStateLedgerApplyStateJournalCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ApplyStateJournal", reflect.TypeOf((*MockStateLedger)(nil).ApplyStateJournal), blockNumber, stateJournal)
	return &MockStateLedgerApplyStateJournalCall{Call: call}
}

// MockStateLedgerApplyStateJournalCall wrap *gomock.Call
type MockStateLedgerApplyStateJournalCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockStateLedgerApplyStateJournalCall) Return(arg0 error) *MockStateLedgerApplyStateJournalCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateLedgerApplyStateJournalCall) Do(f func(uint64, *types.StateJournal) error) *MockStateLedgerApplyStateJournalCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateLedgerApplyStateJournalCall) DoAndReturn(f func(uint64, *types.StateJournal) error) *MockStateLedgerApplyStateJournalCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Archive mocks base method.
func (m *MockStateLedger) Archive(blockHeader *types.BlockHeader, stateJournal *types.StateJournal) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Archive", blockHeader, stateJournal)
	ret0, _ := ret[0].(error)
	return ret0
}

// Archive indicates an expected call of Archive.
func (mr *MockStateLedgerMockRecorder) Archive(blockHeader, stateJournal any) *MockStateLedgerArchiveCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Archive", reflect.TypeOf((*MockStateLedger)(nil).Archive), blockHeader, stateJournal)
	return &MockStateLedgerArchiveCall{Call: call}
}

// MockStateLedgerArchiveCall wrap *gomock.Call
type MockStateLedgerArchiveCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockStateLedgerArchiveCall) Return(arg0 error) *MockStateLedgerArchiveCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateLedgerArchiveCall) Do(f func(*types.BlockHeader, *types.StateJournal) error) *MockStateLedgerArchiveCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateLedgerArchiveCall) DoAndReturn(f func(*types.BlockHeader, *types.StateJournal) error) *MockStateLedgerArchiveCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockStateLedger) Commit() (*types.StateJournal, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Commit")
	ret0, _ := ret[0].(*types.StateJournal)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockStateLedgerCommitCall) Return(arg0 *types.StateJournal, arg1 error) *MockStateLedgerCommitCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateLedgerCommitCall) Do(f func() (*types.StateJournal, error)) *MockStateLedgerCommitCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateLedgerCommitCall) DoAndReturn(f func() (*types.StateJournal, error)) *MockStateLedgerCommitCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// GetStateJournal mocks base method.
func (m *MockStateLedger) GetStateJournal(blockNumber uint64) *types.StateJournal {
	m.ctrl.T.Helper()
...
// GetStateJournal indicates an expected call of GetStateJournal.
func (mr *MockStateLedgerMockRecorder) GetStateJournal(blockNumber any) *MockStateLedgerGetStateJournalCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetStateJournal", reflect.TypeOf((*MockStateLedger)(nil).GetStateJournal), blockNumber)
	return &MockStateLedgerGetStateJournalCall{Call: call}
}

// MockStateLedgerGetStateJournalCall wrap *gomock.Call
type MockStateLedgerGetStateJournalCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockStateLedgerGetStateJournalCall) Return(arg0 *types.StateJournal) *MockStateLedgerGetStateJournalCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateLedgerGetStateJournalCall) Do(f func(uint64) *types.StateJournal) *MockStateLedgerGetStateJournalCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateLedgerGetStateJournalCall) DoAndReturn(f func(uint64) *types.StateJournal) *MockStateLedgerGetStateJournalCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// GetTrieSnapshotMeta mocks base method.
func (m *MockStateLedger) GetTrieSnapshotMeta() (*utils.SnapshotMeta, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTrieSnapshotMeta")
	ret0, _ := ret[0].(*utils.SnapshotMeta)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// Return rewrite *gomock.Call.Return
func (c *MockStateLedgerGetTrieSnapshotMetaCall) Return(arg0 *utils.SnapshotMeta, arg1 error) *MockStateLedgerGetTrieSnapshotMetaCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateLedgerGetTrieSnapshotMetaCall) Do(f func() (*utils.SnapshotMeta, error)) *MockStateLedgerGetTrieSnapshotMetaCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateLedgerGetTrieSnapshotMetaCall) DoAndReturn(f func() (*utils.SnapshotMeta, error)) *MockStateLedgerGetTrieSnapshotMetaCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
func (m *MockStateLedger) IterateTrie(snapshotMeta *utils.SnapshotMeta, kv kv.Storage, errC chan error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockStateLedgerIterateTrieCall) Do(f func(*utils.SnapshotMeta, kv.Storage, chan error)) *MockStateLedgerIterateTrieCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateLedgerIterateTrieCall) DoAndReturn(f func(*utils.SnapshotMeta, kv.Storage, chan error)) *MockStateLedgerIterateTrieCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// UpdateChainState mocks base method.
func (m *MockStateLedger) UpdateChainState(chainState *chainstate.ChainState) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "UpdateChainState", chainState)
}

// UpdateChainState indicates an expected call of UpdateChainState.
func (mr *MockStateLedgerMockRecorder) UpdateChainState(chainState any) *MockStateLedgerUpdateChainStateCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateChainState", reflect.TypeOf((*MockStateLedger)(nil).UpdateChainState), chainState)
	return &MockStateLedgerUpdateChainStateCall{Call: call}
}

// MockStateLedgerUpdateChainStateCall wrap *gomock.Call
type MockStateLedgerUpdateChainStateCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockStateLedgerUpdateChainStateCall) Return() *MockStateLedgerUpdateChainStateCall {
	c.Call = c.Call.Return()
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateLedgerUpdateChainStateCall) Do(f func(*chainstate.ChainState)) *MockStateLedgerUpdateChainStateCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateLedgerUpdateChainStateCall) DoAndReturn(f func(*chainstate.ChainState)) *MockStateLedgerUpdateChainStateCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
...
// Commit mocks base method.
func (m *MockStateAccessor) Commit() (*types.StateJournal, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Commit")
	ret0, _ := ret[0].(*types.StateJournal)
	ret1, _ := ret[1].(error)
...
// Return rewrite *gomock.Call.Return
func (c *MockStateAccessorCommitCall) Return(arg0 *types.StateJournal, arg1 error) *MockStateAccessorCommitCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockStateAccessorCommitCall) Do(f func() (*types.StateJournal, error)) *MockStateAccessorCommitCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockStateAccessorCommitCall) DoAndReturn(f func() (*types.StateJournal, error)) *MockStateAccessorCommitCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
